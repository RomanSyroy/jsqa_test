...
const keysOfUkraine = Object.keys(Ukraine);
const valuesOfUkraine = Object.values(Ukraine);

for (let i = 0; i < keysOfUkraine.length; i++) {
  console.log(keysOfUkraine[i], '=', valuesOfUkraine[i]);
}
