...
console.log( 'sortNumbers = ' + primeNumbers);
...
var c = [21, 63, 84];
var d = 42
function adding(numberFromArray) {
	numberFromArray += d;
console.log('numberFromArray = ' + numberFromArray);
}
c.forEach(adding);
...
function arrayCleanUp(arrayToCleanUp) {
	...
	cleanedUp = cleanedUp.filter(function(element) {
